...
public class UserAccount {
    ...
    private String supervisingLecturer;
    ...
    public String getSupervisingLecturer() { return supervisingLecturer; }
    public void setSupervisingLecturer(String supervisingLecturer) { this.supervisingLecturer = supervisingLecturer; }
